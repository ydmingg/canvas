...
var init = function (_a) {
    var node = _a.node, url = _a.url, name = _a.name, time = _a.time, content = _a.content;
    var initdata = {
        radius: 32,
        borderWidth: 4,
        width: 260,
    ...
    state.on('click', function () {
        ...
        var textContent = new Konva.Text({
            x: textName.x(),
...
var creat = function () {
    var textData = document.querySelectorAll("#Text li input");
    var textBtn = document.querySelector("#Text li.list.row.justify-end button");
    ...
    textBtn.addEventListener("click", function () {
        var url = textData[0].value;
        var name = textData[1].value;
        var content = textData[2].value;
        init({
            node: app,
            url: url,
            name: name,
