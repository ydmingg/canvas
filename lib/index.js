...
var canvas = {
    index: "<div class=\"m-32 bg-gray-200\" fxtag=\"canvas\"></div>",
};

var commentBox = function (stage, layer, comments, x, y) {
    var scale = stage.scaleX();
    var adjustedX = (x - stage.x()) / scale;
    var adjustedY = (y - stage.y()) / scale;
    var commentBox = new Konva.Circle({
        x: adjustedX,
        y: adjustedY,
        fill: 'yellow',
        radius: 10,
...
var pages = function () {
    ...
    var oCanvas = document.querySelector('[fxtag="canvas"]');
    ...
    stage.on('wheel', function (e) {
        ...
        var commentBoxes = layer.find('.commentBox');
        commentBoxes.forEach(function (box, idx) {
            var originalRadius = box.getAttr('originalRadius');
    ...
    stage.on('click', function (e) {
        var position = stage.getPointerPosition() || { x: 0, y: 0 };
        commentBox(stage, layer, comments, position.x, position.y);
    });
};
