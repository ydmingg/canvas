...
var commentBox = function (stage, layer, x, y, index) {
    ...
    var commentBoxBg = new Konva.Circle({
        x: 0,
        y: 0,
        fill: 'yellow',
        radius: fixedRadius,
    ...
    var commentBoxText = new Konva.Text({
        text: index.toString(),
        x: 0,
        y: 0,
        fontSize: 12,
...
var pages = function () {
    ...
    stage.on('click', function (e) {
        ...
        index++;
        console.log(index);
        commentBox(stage, layer, position.x, position.y, index);
    });
};
