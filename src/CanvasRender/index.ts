...
import { defaultSettings } from "../CanvasRender/config";
...
export class CanvasRender { 
    ...
    constructor(app: HTMLDivElement, width: number, height: number) { 
        const opts = { ...defaultSettings, width, height };
        const core = new Core<IDrawEvent>(app, { width, height, devicePixelRatio });
        this.CORE = core
        this.OPTS = opts;
...
// import Konva from "konva";
// import { CanvasComponentsMap, CanvasComponentsType } from "../types/index";
